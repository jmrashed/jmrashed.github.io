                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5">
                        <div class="single-footer-caption">
                            <div class="footer-tittle">
                                <h4>Quick Links</h4>
                                <ul>
                                    <li class="single-list"><a target="_blank" href="https://leetcode.com/jmrashed/">leetcode</a>
                                    </li>
                                    <li class="single-list"><a target="_blank" href="https://www.hackerrank.com/jmrashed">hackerrank</a></li>
                                    <li class="single-list"><a target="_blank" href="https://codeforces.com/profile/jmrashed">codeforces</a></li>
                                    <li class="single-list"><a target="_blank" href="https://profiles.topcoder.com/jmrashed">topcoder</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script src="<?= $asset_path ?>assets/js/popper.min.js"></script>
<script src="<?= $asset_path ?>assets/js/bootstrap-5.0.2.min.js"></script>
<!-- Plugin -->
<script src="<?= $asset_path ?>assets/js/plugin.js"></script>
<!-- Main js-->
<script src="<?= $asset_path ?>assets/js/mian.js"></script>
