        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <AnimatedSection direction="left">
            <h3 className="text-3xl font-bold text-white mb-6 leading-snug">
              Driving Innovation,{" "}
              <span className="gradient-text">Building Impact</span>
            </h3>

            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                As a <span className="text-white font-medium">Tech Leader with 10+ years of experience</span>, I have
                transformed ideas into scalable, high-impact software solutions, leading teams of engineers to deliver
                products that accelerate business growth.
              </p>
              <p>
                Currently spearheading a{" "}
                <span className="text-emerald-400 font-medium">36-member development team at Onest Tech LLC</span>, I
                blend deep technical expertise in{" "}
                <span className="text-indigo-300">PHP, Node.js, React, and Cloud Infrastructure</span> with strategic
                leadership.
              </p>
              <p>
                Passionate about fostering a culture of{" "}
                <span className="text-amber-300 font-medium">innovation, mentorship, and continuous learning</span>,
                empowering engineers to grow while driving organizational success.
              </p>
            </div>

            {/* Stats grid */}
            <StaggerContainer className="grid grid-cols-3 gap-3 mt-10" staggerDelay={0.07} initialDelay={0.1}>
              {stats.map((stat) => (
              ...
              {[
                {
                  ...
                  color: "#f97316",
                  stats: [{ v: "320", l: "Solved" }, { v: "55%", l: "Acceptance" }],
                },
                {
                  ...
                  color: "#22c55e",
                  stats: [{ v: "180", l: "Challenges" }, { v: "30", l: "Certs" }],
                },
              ].map((p) => (
                <Link
                  key={p.name}
            ...
            >
              <div className="text-5xl text-indigo-500/20 font-serif absolute top-2 left-4 leading-none select-none">&ldquo;</div>
              <p className="text-gray-300 italic leading-relaxed pl-4">
                I don&apos;t just build software — I build solutions that scale, empower businesses, and inspire teams to achieve more.
              </p>
            </div>
              ...
              <div className="card-glass p-8">
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.06]">
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: GraduationCap, text: "B.Sc. Computer Science & Engineering — CGPA 3.73", color: "text-indigo-400" },
                      { icon: Award, text: "Project Management — Rice University", color: "text-emerald-400" },
                      { icon: Award, text: "Web Development Specialization — University of Michigan", color: "text-purple-400" },
                    ].map((e, i) => (
