  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link href="/case-studies" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 mb-8 transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back to Case Studies
        </Link>

        <div className="card-glass p-8 mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-blue-300 mb-3">{cs.title}</h1>
          <p className="text-gray-400 mb-6">Client: <span className="text-gray-200">{cs.client}</span> · Industry: <span className="text-gray-200">{cs.industry}</span></p>
